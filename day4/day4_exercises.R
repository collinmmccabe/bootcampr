...
# In base R, you do this with readChar()
 # readChar() requires you to state length
...
# Here, the read function is just as you'd expect: read.xlsx()
 # need to provide a sheet number
...
github_url <- "https://api.github.com/repos/collinmmccabe/bootcampR/commits"
...
imdb_url <- "https://www.imdb.com/title/tt1267297/"
