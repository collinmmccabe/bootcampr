...
# another added bonus of using the tidyverse function in this case.header only takes logical values
...
read.xlsx("day4/data/crimebyyear_multisheet.xlsx") # need to provide a sheet number
read.xlsx("day4/data/crimebyyear_multisheet.xlsx", 1)
...
read_excel("day4/data/crimebyyear_multisheet.xlsx", sheet = 2, skip = 3)
